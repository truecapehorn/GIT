...
def post_detail(request, year, month, day, post):
    ...
    if request.method == 'POST':
        ...
        if comment_form.is_valid():
            # Utworzenie obiektu Comment, ale jeszcze nie zapisujemy go w bazie
            # danych.
...
def post_share(request, post_id):
    ...
    # print(post) -  post= tytul udostepnianego posta
    sent = False
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # cd={'email': 'truecapehorn@gmail.com', 'comments': 'cd', 'name':
            # 'django', 'to': 'tito02@o2.pl'}
