...
def base(lista):
    ...
    for i in lista:
        ...
        Database.objects.create(data_dodania=dataDodania,author=me, inwestor=i[5], nr_umowy=i[6],kod=i[7],kierownik=i[9], fv=i[10], projekt=i[11],uwagi=i[15], kraj=i[16],lp=int(i[0]),sufix=i[1])
